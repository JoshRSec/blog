...
If the threat model ever expands to "someone else picks up my unlocked machine" - rather than "malware running as me," which the above doesn't fully solve either way - there are two tiers of Windows Hello integration worth considering, increasing in strength and cost:
